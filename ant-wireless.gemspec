# -*- encoding: utf-8 -*-
# stub: ant-wireless 0.1.0.pre.20210617163414 ruby lib
# stub: ext/ant_ext/extconf.rb

Gem::Specification.new do |s|
  s.name = "ant-wireless".freeze
  s.version = "0.1.0.pre.20210617163414"

  s.required_rubygems_version = Gem::Requirement.new("> 1.3.1".freeze) if s.respond_to? :required_rubygems_version=
  s.metadata = { "bug_tracker_uri" => "https://todo.sr.ht/~ged/ruby-ant-wireless", "documentation_uri" => "https://dev.ravn.com/docs/ruby-ant", "homepage_uri" => "https://sr.ht/~ged/ruby-ant-wireless/", "source_uri" => "https://hg.sr.ht/~ged/ruby-ant-wireless" } if s.respond_to? :metadata=
  ...
  s.files = ["History.md".freeze, "LICENSE.txt".freeze, "README.md".freeze, "ext/ant_ext/ant_ext.c".freeze, "ext/ant_ext/ant_ext.h".freeze, "ext/ant_ext/antdefines.h".freeze, "ext/ant_ext/antmessage.h".freeze, "ext/ant_ext/build_version.h".freeze, "ext/ant_ext/callbacks.c".freeze, "ext/ant_ext/channel.c".freeze, "ext/ant_ext/defines.h".freeze, "ext/ant_ext/event.c".freeze, "ext/ant_ext/extconf.rb".freeze, "ext/ant_ext/message.c".freeze, "ext/ant_ext/types.h".freeze, "ext/ant_ext/version.h".freeze, "lib/ant.rb".freeze, "lib/ant/channel.rb".freeze, "lib/ant/channel/event_callbacks.rb".freeze, "lib/ant/event.rb".freeze, "lib/ant/message.rb".freeze, "lib/ant/mixins.rb".freeze, "lib/ant/response_callbacks.rb".freeze, "lib/ant/wireless.rb".freeze, "spec/ant_spec.rb".freeze, "spec/spec_helper.rb".freeze]
