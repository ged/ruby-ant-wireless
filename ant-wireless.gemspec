...
Gem::Specification.new do |s|
  ...
  s.files = ["History.md".freeze, "LICENSE.txt".freeze, "README.md".freeze, "ext/ant_ext/ant_ext.c".freeze, "ext/ant_ext/ant_ext.h".freeze, "ext/ant_ext/antdefines.h".freeze, "ext/ant_ext/antmessage.h".freeze, "ext/ant_ext/build_version.h".freeze, "ext/ant_ext/callbacks.c".freeze, "ext/ant_ext/channel.c".freeze, "ext/ant_ext/defines.h".freeze, "ext/ant_ext/extconf.rb".freeze, "ext/ant_ext/message.c".freeze, "ext/ant_ext/types.h".freeze, "ext/ant_ext/version.h".freeze, "lib/ant-wireless.rb".freeze, "lib/ant.rb".freeze, "lib/ant/bitvector.rb".freeze, "lib/ant/channel.rb".freeze, "lib/ant/channel/event_callbacks.rb".freeze, "lib/ant/message.rb".freeze, "lib/ant/mixins.rb".freeze, "lib/ant/response_callbacks.rb".freeze, "lib/ant/wireless.rb".freeze, "spec/ant_spec.rb".freeze, "spec/bitvector_spec.rb".freeze, "spec/spec_helper.rb".freeze]
